...
>
		...
		<Content>
			<ul>
				...
				<ul>
					...
					<li class="fragment">
						Cloud Functions för att koppla Firebase Auth med Firebase Firestore
					</li>
				</ul>
			</ul>
		</Content>
	...
	<Slide>
		<Title title="Dagens Demo"></Title>
		<Content>
			<ul>
				<li class="fragment">Skapa Firebase projekt</li>
				<li class="fragment">Konfigurera Authentisering (email + lösenord)</li>
				...
				<li class="fragment">Allt för godkänt som rör Firebase</li>
			</ul>
		</Content>
	</Slide>
		...
		<Content>
			<ul>
				...
				<ul>
					...
					<li class="fragment">
						Realtidsuppdateringar möjliga, men inte idag, se länkad dokumentation i uppgift
					</li>
				</ul>
	...
	<Slide>
		...
		<Content>
			<ul>
				...
				<li class="fragment">
					iOS/macOS config endast om du har Mac (när du konfigurerar firebase)
				</li>
				<li class="fragment">Viktigt med rätt application/bundle ID för iOS/Android</li>
				<ul>
					<li class="fragment">
						finns i källkoden för android i <code>build.gradle</code> och läses i Xcode på Mac
					</li>
					<li class="fragment">Firebase CLI hanterar detta åt er.</li>
				</ul>
