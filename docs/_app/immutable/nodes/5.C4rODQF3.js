import{f as T,g as s,t as o,i as n,j as e,k as a}from"../chunks/disclose-version.BAOoFInd.js";import{s as P,B as D,z as F,f as we}from"../chunks/runtime.Bix74eL6.js";import{e as E}from"../chunks/render.DvSWKrhB.js";import{b as H}from"../chunks/this.wyHJEu0o.js";import{S as N,C as q}from"../chunks/split.DmvM2kU1.js";import{P as be,S,T as w,C as b}from"../chunks/content.Cka6NWLM.js";import{F as Re}from"../chunks/front.DzTqcsJY.js";var je=o(`<ol><li class="fragment">Fokus på asynkrona anrop & hämta data över nätverk</li> <li class="fragment">Lite översiktligt om routing, json & http-requests</li> <li class="fragment"><strong>Repository-klasserna ska utföra sina operationer mot den server ni programmerar i
...
}`},!1),s(m,v)},$$slots:{default:!0}}),s(u,l)},$$slots:{default:!0}}),s(i,t)},$$slots:{default:!0}});var Q=e(e(z,!0));S(Q,{in:async()=>{P(c,!1),await L.update``},children:(i,R)=>{var t=qe(),r=n(t);w(r,{title:"JSON - Data-utbytesformat"});var d=e(e(r,!0));b(d,{children:(u,j)=>{var l=T(!0),$=n(l);N($,{children:(m,I)=>{var v=Ne(),p=n(v),g=a(p),h=e(e(g,!0)),y=e(e(h,!0)),_=e(e(p,!0)),f=a(_),k=a(f);H(q(k,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),x=>L=x,()=>L),D(()=>f.hidden=!F(c)),E("current",y,async()=>{P(c,!0),await L.update`final items = [];
...
}`},!1),s(m,v)},$$slots:{default:!0}}),s(u,l)},$$slots:{default:!0}}),s(i,t)},$$slots:{default:!0}});var X=e(e(Q,!0));S(X,{in:async()=>{P(c,!1),await J.update``},children:(i,R)=>{var t=Ue(),r=n(t);w(r,{title:"Routing - Dirigera förfrågningar"});var d=e(e(r,!0));b(d,{children:(u,j)=>{var l=T(!0),$=n(l);N($,{children:(m,I)=>{var v=Ce(),p=n(v),g=a(p),h=e(e(g,!0)),y=e(e(p,!0)),_=a(y),f=a(_);H(q(f,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),k=>J=k,()=>J),D(()=>_.hidden=!F(c)),E("current",h,async()=>{P(c,!0),await J.update`final Router app = Router();
...
}`},!1),s(m,v)},$$slots:{default:!0}}),s(u,l)},$$slots:{default:!0}}),s(i,t)},$$slots:{default:!0}});var Y=e(e(X,!0));S(Y,{in:async()=>{P(c,!1),await G.update``},children:(i,R)=>{var t=Je(),r=n(t);w(r,{title:"Asynkrona anrop"});var d=e(e(r,!0));b(d,{children:(u,j)=>{var l=T(!0),$=n(l);N($,{children:(m,I)=>{var v=Le(),p=n(v),g=a(p),h=e(e(g,!0)),y=e(e(h,!0)),_=e(e(p,!0)),f=a(_),k=a(f);H(q(k,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),x=>G=x,()=>G),D(()=>f.hidden=!F(c)),E("current",y,async()=>{P(c,!0),await G.update`Future<Response> _postItemsHandler(Request request) async {
  final data = await request.readAsString();
  final json = jsonDecode(data);
  items.add(json);
  return Response.ok(
...
}`},!1),s(m,v)},$$slots:{default:!0}}),s(u,l)},$$slots:{default:!0}}),s(i,t)},$$slots:{default:!0}});var Z=e(e(Y,!0));S(Z,{in:async()=>{P(c,!1),await O.update``},children:(i,R)=>{var t=Oe(),r=n(t);w(r,{title:"Implementering av Repository-mönstret"});var d=e(e(r,!0));b(d,{children:(u,j)=>{var l=T(!0),$=n(l);N($,{children:(m,I)=>{var v=Ge(),p=n(v),g=a(p),h=e(e(g,!0)),y=e(e(h,!0)),_=e(e(p,!0)),f=a(_),k=a(f);H(q(k,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),x=>O=x,()=>O),D(()=>f.hidden=!F(c)),E("current",y,async()=>{P(c,!0),await O.update`class DataRepository {
...
}`},!1),s(m,v)},$$slots:{default:!0}}),s(u,l)},$$slots:{default:!0}}),s(i,t)},$$slots:{default:!0}});var ee=e(e(Z,!0));S(ee,{in:async()=>{P(c,!1),await C.update``},children:(i,R)=>{var t=Ve(),r=n(t);w(r,{title:"Typsäker datahantering med fromJson och toJson"});var d=e(e(r,!0));b(d,{children:(u,j)=>{var l=T(!0),$=n(l);N($,{children:(m,I)=>{var v=Ae(),p=n(v),g=a(p),h=e(e(g,!0)),y=e(e(h,!0)),_=e(e(p,!0)),f=a(_),k=a(f);H(q(k,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),x=>C=x,()=>C),D(()=>f.hidden=!F(c)),E("current",g,async()=>{P(c,!0),await C.update`class Item {
