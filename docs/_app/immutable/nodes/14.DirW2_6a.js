...
}`},!1),r(x,g)},$$slots:{default:!0}}),r(d,l)},$$slots:{default:!0}}),r(s,a)},$$slots:{default:!0}});var J=e(e(z,!0));_(J,{in:async()=>{p(c,!1),await F.update``},children:(s,k)=>{var a=$e(),t=n(a);$(t,{title:"Mixins - Återanvändbar Funktionalitet"});var o=e(e(t,!0));h(o,{children:(d,y)=>{var l=A(!0),b=n(l);V(b,{children:(x,B)=>{var g=_e(),v=n(g),S=u(v),P=e(e(S,!0)),w=e(e(v,!0)),f=u(w),m=u(f);M(j(m,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),T=>F=T,()=>F),L(()=>f.hidden=!C(c)),N("current",P,async()=>{p(c,!0),await F.update`mixin Loggable {
...
}`},!1),r(x,g)},$$slots:{default:!0}}),r(d,l)},$$slots:{default:!0}}),r(s,a)},$$slots:{default:!0}});var q=e(e(J,!0));_(q,{in:async()=>{p(c,!1),await U.update``},children:(s,k)=>{var a=ke(),t=n(a);$(t,{title:"Patterns - Modern Datahantering"});var o=e(e(t,!0));h(o,{children:(d,y)=>{var l=A(!0),b=n(l);V(b,{children:(x,B)=>{var g=he(),v=n(g),S=u(v),P=e(e(S,!0)),w=e(e(P,!0)),f=e(e(v,!0)),m=u(f),T=u(m);M(j(T,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),E=>U=E,()=>U),L(()=>m.hidden=!C(c)),N("current",w,async()=>{p(c,!0),await U.update`// Object destructuring
...
String getDeviceType(Map<String, dynamic> device) =>
  switch (device) {
    ...
    _ => 'Unknown'
  };`},!1),r(x,g)},$$slots:{default:!0}}),r(d,l)},$$slots:{default:!0}}),r(s,a)},$$slots:{default:!0}});var W=e(e(q,!0));_(W,{in:async()=>{p(c,!1),await I.update``},children:(s,k)=>{var a=be(),t=n(a);$(t,{title:"Isolates - Parallell Exekvering"});var o=e(e(t,!0));h(o,{children:(d,y)=>{var l=A(!0),b=n(l);V(b,{children:(x,B)=>{var g=ye(),v=n(g),S=u(v),P=e(e(S,!0)),w=e(e(P,!0)),f=e(e(v,!0)),m=u(f),T=u(m);M(j(T,{code:"",theme:"catppuccin-frappe",lang:"dart",autoIndent:!0,options:{duration:600,stagger:15,containerStyle:!1,lineNumbers:!0},class:"overflow-y-clip"}),E=>I=E,()=>I),L(()=>m.hidden=!C(c)),N("current",w,async()=>{p(c,!0),await I.update`import 'dart:isolate';
